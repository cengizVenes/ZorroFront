...
function picturechange() {
  ...
  var img1 = "../../assets/images/productImg/product1.webp";
  var img2 = "../../assets/images/productImg/product2.webp";
  var img3 = "../../assets/images/productImg/product3.webp";
  var img4 = "../../assets/images/productImg/product4.webp";
  viewImg.src = img1;
...
function sizeguide() {
  ...
  for (var i = 0; i < butonlar.length; i++) {
    butonlar[i].addEventListener("click", function () {
      ...
      if (acikMi) {
        picture.src = "../../assets/images/L0001 copy.png";
      } else {
        picture.src = "../../assets/images/Şekil 1.png";
      }
...
function coppy() {
  ...
  for (var i = 0; i < butonlar.length; i++) {
    butonlar[i].addEventListener("click", function () {
      ...
      if (acikMi) {
        picture.src = "../../assets/images/Icon CompareDark.png";
      } else {
        picture.src = "../../assets/images/Icon Comparep.png";
      }
      // data-open özelliğini tersine çevirin
      this.setAttribute("data-open", acikMi ? "false" : "true");
    });
...
function heart() {
  ...
  for (var i = 0; i < butonlar.length; i++) {
    butonlar[i].addEventListener("click", function () {
      ...
      if (acikMi) {
        picture.src = "../../assets/images/Katman 1.png";
      } else {
        picture.src = "../../assets/images/Icon HeartP.png";
      }
...
function imgchange() {
  var resimler = [
    ...
    "../../assets/images/productImg/product2.webp",
    "../../assets/images/productImg/product3.webp",
    "../../assets/images/productImg/product4.webp",
  ];
...
function UpdatemoreLess() {
  ...
  if (dots.style.display === "none") {
    // "none" durumunu kontrol etmeyi kaldırın, direkt olarak "inline" veya "block" yapın
    dots.style.display = "inline";
