                ...
                <div class="">
                    <div class=" bg-white shadow rounded-1">
                        ...
                        <div id="veri-listesi" class="AllProduct content row m-0 justify-content-start position-relative z-0">
                            <div class="col-12 col-sm-6 col-xl-3 border-end border-bottom itemsPage ">
                                <div class="row">
                            ...
                            <nav id="sayfalama" aria-label="Page navigation example">
                                <ul class="pagination justify-content-center stilla my-3">
                                    <li id="onceki" class="page-item me-1 me-sm-2">
                                        <a class=" rounded-0 text-decoration-none h-100 me-2  still justify-content-center d-flex align-items-center" href="#" aria-label="Previous">
                                            <span class=" cardHeaderlink d-flex align-items-center" aria-hidden="true"><i class="fa-solid fa-angle-left colorcacbcd me-2"></i>Prev</span>
                                        </a>
                                    </li>
                                    <div id="sayfa-numarasi" class="d-flex stilla">
                                        <li class="page-item m-1 m-sm-2">
                                            <div class="h-100 d-flex align-items-center justify-content-center">
                                                <div class="wh  d-flex align-items-center justify-content-center rounded-1">
                                                    <a class="justify-content-center page-button text-decoration-none d-flex align-items-center colorfff bgDarkPink
                                                        changePage1 " href="#">1</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="page-item m-1 m-sm-2">
                                            <div class="h-100 d-flex align-items-center justify-content-center">
                                                <div class="wh d-flex align-items-center justify-content-center rounded-1">
                                                    <a class="justify-content-center page-button text-decoration-none d-flex align-items-center colorcacbcd  
                                                        changePage1 " href="#">2</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="page-item m-1 m-sm-2 ">
                                        ...
                                        <li class="page-item m-1 m-sm-2 ">
                                            <div class="h-100 d-flex align-items-center justify-content-center">
                                                <div class="wh d-flex align-items-center justify-content-center rounded-1">
                                                    <a class="justify-content-center page-button text-decoration-none d-flex align-items-center   colorcacbcd  
                                                        changePage1 " href="#">5</a>
                                                </div>
                                            </div>
                                        </li>
                                    </div>
                                    <li id="sonraki" class="page-item ms-1 ms-sm-2">
                                        <a class=" rounded-0  still justify-content-center h-100 ms-2 d-flex align-items-center text-decoration-none" href="#" aria-label="Next">
                                            <span class="cardHeaderlink d-flex align-items-center" aria-hidden="true">Next<i class="fa-solid fa-angle-right colorcacbcd ms-2"></i></span>
                                        </a>
                                    </li>
                                </ul>
                            </nav>
