                ...
                <div class="row m-0 g-5">
                    ...
                    <div class="col-12 col-xl-9">
                        <div class=" bg-white shadow rounded-1">
                            ...
                            <div id="veri-listesi" class="AllProduct content row m-0 justify-content-end">
                                <div class="col-12 col-sm-6 col-xl-4 border-end border-bottom itemsPage ">
                                    <div class="row">
