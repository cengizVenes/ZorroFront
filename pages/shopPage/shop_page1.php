                    ...
                    <div class="col-12 col-xl-3 d-none d-xl-block">
                        <div class="bg-white shadow rounded-1">
                            <div class="p-3 border-bottom">
                                <div class="m-1">
                                    <h2 class="fs12px cardHeaderlink fw-bold mb-0">
                                        Filter
                                    </h2>
                                </div>
                            </div>
                        ...
                        <div class=" bg-white shadow rounded-1">
                            ...
                            <div id="veri-listesi" class="AllProduct content ">
                                <div class="row m-0 border-bottom itemsPage">
                                    <div class="col-md-4 col-lg-12 col-xl-4" id="productButton1">
                                    ...
                                    <div class="col-md-5 col-lg-12 col-xl-5">
                                        <div class="pt-5">
                                            ...
                                            <p class="liteGrey pe-sm-5 me-sm-5">Modern Plastic Armchair
                                                Rocker
                                            </p>
                                            <div class="d-flex align-items-center">
                                                <label class="stars" for="customer1">
                                            ...
                                            <p class="liteGrey fs12px">
                                                Maecenas finibus aliquam lacus, interdum ultricies quam laoreet eu.
                                                Vestibulum nec congue mauris. Cras iaculis iaculis lectus, nec auctor
                                                velit
                                                commodo eget. Orci varius natoque penatibus et magnis dis.
                                            </p>
                                            <p class="liteGrey fs14px mt-2">
                                                Availability :<span class="darkPink"> In stock</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-12 col-xl-3 ">
                                        <div class=" d-flex align-items-center justify-content-center h-100 ">
                                            <div class="p-4 productBrRes d-flex d-md-block d-lg-flex d-xl-block align-items-center mt-3 mt-md-0 mt-lg-3 mt-xl-0">
                                                <div class="  d-block d-lg-flex d-xl-block align-items-center">
                                                    <div class="mx-2">
                                                        <p class="liteGrey text-nowrap">
                                                            <sup class="mt-2">$</sup>199 &nbsp;
                                                            <small class="fs12px"><del>&nbsp;$219&nbsp;</del></small>
                                                        </p>
                                                    </div>
                                                    <div class="d-flex justify-content-center my-sm-2 mx-sm-2">
                                                        <button class="productButon rounded-1 border-0 fs10  py-2 px-3 my-2 mx-auto text-nowrap">Add
                                                            to Card</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-block d-lg-flex d-xl-block align-items-center">
                                                    <div class=" my-2 mx-2">
                                                        <button class="text-decoration-none fs12px d-flex align-items-center liteGrey border-0 bg-transparent ps-0 starting">
                                                            <img class="picture" src="../../assets/images/Icon Heart.png" alt="">
                                                            <p class="ms-1">Wishlist</p>
                                                        </button>
                                                    </div>
                                                    <div class="mx-2">
                                                        <button class="text-decoration-none fs12px d-flex align-items-center liteGrey border-0 bg-transparent ps-0 starting">
                                                            <img class="copy" src="../../assets/images/Icon Compare.png" alt="">
                                                            <p class="ms-1">Compare</p>
                                                        </button>
                                                    </div>
                                                </div>
                                ...
                                <div class="row m-0 border-bottom itemsPage">
                                    <div class="col-md-4 col-lg-12 col-xl-4" id="productButton2">
                                        <div class=" position-relative">
                                            <div class="d-flex justify-content-center">
                                ...
                                <div class="row m-0 border-bottom itemsPage">
                                    <div class="col-md-4 col-lg-12 col-xl-4">
                                        <div class=" position-relative">
                                            <div class="d-flex justify-content-center">
                                                <img class=" maxHeight maxWidth100" src="../../assets/images/productImg/product1.webp" alt="product">
                                            </div>
                                            <div class="clipPath2 rounded-end-1 p-1 ps-3 pe-2 position-absolute top-0 end-0">
                                                <p class="fs10 fw-bold text-white">25% OFF</p>
                                            </div>
                                        ...
                                        <div class=" d-flex align-items-center justify-content-center h-100 ">
                                            <div class="p-4 productBrRes d-flex d-md-block d-lg-flex d-xl-block align-items-center mt-3 mt-md-0 mt-lg-3 mt-xl-0">
                                                <div class="  d-block d-lg-flex d-xl-block align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-center my-sm-2 mx-sm-2">
                                                        <button class="productButon rounded-1 border-0 fs10  py-2 px-3 my-2 mx-auto text-nowrap bgcacbcd disabledCursor">Add
                                                            to Card</button>
                                                    </div>
                                                </div>
