...
<head>
    <title>ZORRO-MYACCOUNTSIGNIN</title>
                        ...
                        <div class=" d-flex w-100 justify-content-center my-7">
                            <div class="maxw425px w-100">
                                <div class=" d-flex justify-content-between ">
                                    <div><a href="#" class="darkPink text-decoration-none fw-600 ">SIGN IN</a></div>
                                    <div><a href="#" class="color676970 text-decoration-none fw-600">REGISTER</a></div>
                                </div>
