    ...
    <main>
        ...
        <div class="container-fluid mt-115px z-3 position-relative ">
            <div class="container-sm">
                <div class="row  pt-4 justify-content-center mx-0 mb-60">
                    <div class="col-12 col-sm-8 bg-white shadow-sm rounded-1 px-5 p-sm-0">
                        <div class=" d-flex w-100 justify-content-center my-7">
                            <div class="maxw425px w-100">
                                <div class=" d-flex justify-content-between ">
                                    <div><a href="#" class="color676970 text-decoration-none fw-600 ">SIGN IN</a></div>
                                    <div><a href="#" class=" darkPink text-decoration-none fw-600">REGISTER</a></div>
                                </div>
                                <form class=" my-4 myAccountForm" action="">
                                    ...
                                    <p class="color676970 fs12px mt-3 mb-5">Your personal data will be used to support
                                        your
